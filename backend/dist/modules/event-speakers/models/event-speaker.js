...
exports.eventSpeakers = (0, pg_core_2.pgTable)("event_speakers", {
    ...
    teamMemberId: (0, pg_core_1.uuid)("team_member_id").references(() => team_member_1.teamMembers.id),
